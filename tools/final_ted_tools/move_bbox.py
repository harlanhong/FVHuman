...
# 文件所在的目录
source_dir = "/mnt/localssd/final_ted_v5/_dwpose"
destination_dir = "/mnt/localssd/final_ted_dataset/bbox/"
...
for file_name in files:
    ...
    # 移动文件到对应的 ID 文件夹中
    shutil.copy(os.path.join(source_dir, file_name), os.path.join(id_folder, file_name))
