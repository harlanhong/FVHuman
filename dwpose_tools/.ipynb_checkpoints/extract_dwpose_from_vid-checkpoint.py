...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", type=str, default="/mnt/localssd/motionx/video/animation/")
    parser.add_argument("--resume", default=False, action="store_true")
    parser.add_argument(
        "--save_dir", type=str, default="/mnt/localssd/motionx/video/animation/_dwpose/"
    )
    ...
    for video_name in tqdm(todo_video):
        process_single_video(
            video_name, detector, args.video_dir, args.save_dir,
        )
