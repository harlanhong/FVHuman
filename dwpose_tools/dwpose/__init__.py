    ...
    def __call__(
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            whole_score = copy.deepcopy(subset)
            ...
            face_score = whole_score[:, 24:92]
            hands_score = whole_score[:, 92:]
            ...
            return detected_map, whole_score, pose
    ...
    def smooth_image(
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            # if output_type == "pil":
            #     detected_map = Image.fromarray(detected_map)
            return pose, H, W, input_image, image_resolution, body_score

    def process_smoothed_pose(
        self,
        pose,
        H,
        W,
