...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_workers", type=int, default=8, help="Maximum number of threads to use."
    )
    
    args = parser.parse_args()
    root_name = "/mnt/localssd/motionx/video/"
    for video_folder_name in os.listdir(root_name):
        args.save_dir = root_name + video_folder_name + "/_dwpose/"
        args.video_dir = root_name + video_folder_name + "/"
