...
class Wholebody:
    def __init__(self, device="cuda:0"):
        ...
        onnx_det = Path("/projects/p32296/fating/src/novel-view-human-master/tools/dynamichuman/tools/yolox_l.onnx")
        onnx_pose = Path("/projects/p32296/fating/src/novel-view-human-master/tools/dynamichuman/tools/dw-ll_ucoco_384.onnx") 
