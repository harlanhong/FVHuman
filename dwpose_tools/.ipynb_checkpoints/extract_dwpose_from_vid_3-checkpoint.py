...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", type=str, default="/mnt/localssd/ted_dataset/final_ted_v4/")
    parser.add_argument("--resume", default=False, action="store_true")
    parser.add_argument(
        "--save_dir", type=str, default="/mnt/localssd/ted_dataset/final_ted_v4/_dwpose/"
    )
    parser.add_argument(
